...
class SuppliersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supplier" do
    assert_difference('Supplier.count') do
      post suppliers_url, params: { supplier: { supplier_name: '新規サプライヤー', manufacturer_name: '新規メーカー', iso_existence: 'ISO9001取得有り', target: true, qms: 'ISO 9001', second_party_audit: '△', supplier_development: '？', automotive_related: true, departments: '加工課', transaction_details: '新規取引詳細', address1: '新規住所1', address2: '新規住所2', postal_code: '123-4567', tel: '03-1234-5678', fax: '03-1234-5679' } }
    end
